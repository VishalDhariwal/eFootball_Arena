-- Migration: 010_match_stats.sql
-- Description: Add goals tracking to profiles and create tournament_stats table.

-- 1. Update Profiles Table
ALTER TABLE profiles 
ADD COLUMN IF NOT EXISTS total_goals_scored INT DEFAULT 0,
ADD COLUMN IF NOT EXISTS total_goals_conceded INT DEFAULT 0;

-- 2. Create Tournament Stats Table
...
DO $$ BEGIN
  CREATE POLICY "Tournament stats viewable by all" ON tournament_stats FOR SELECT USING (true);
EXCEPTION WHEN duplicate_object THEN null; END $$;

-- 3. Update verify_match_score trigger to track stats
